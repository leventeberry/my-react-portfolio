        ...
        <footer className="footer d-flex container-fluid flex-column align-items-center">
            <div>
                ...
                <a href="https://stackoverflow.com/users/15780740/levente-berry">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 75 124" preserveAspectRatio="xMidYMid meet" className="svg-logo">
                        <script xmlns=""/>
                        <g fill="none" fill-rule="evenodd">
                            <polygon fill="#640707" points="88 80 99 80 99 124 0 124 0 80 11 80 11 113 88 113"/>
                            <path fill="#640707" fill-rule="nonzero" d="M22.9878906,76.73 L77.0128906,88.085 L79.2838906,77.285 L25.2588906,65.925 L22.9878906,76.73 Z M30.1368906,50.861 L80.1828906,74.169 L84.8448906,64.16 L34.7978906,40.852 L30.1368906,50.861 Z M43.9848906,26.308 L86.4128906,61.639 L93.4788906,53.154 L51.0508906,17.824 L43.9848906,26.308 Z M71.3718906,0.192 L62.5118906,6.782 L95.4598906,51.082 L104.319891,44.493 L71.3718906,0.192 Z M22,102 L77,102 L77,91 L22,91 L22,102 Z"/>
                        </g>
                    </svg>
                </a>

                {/* Github Logo */}
                <a href="https://github.com/hokage-216">
                    <svg width="98" height="96" xmlns="http://www.w3.org/2000/svg" className="svg-logo" viewBox="0 0 98 96">
                ...
                <a href="https://www.linkedin.com/in/leventeberry/">
                    <svg fill="#640707" height="75px" width="75px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 310 310" xml:space="preserve" className="svg-logo">
                        <g id="XMLID_801_">
